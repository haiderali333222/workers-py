...
from jobs.competitors.alliedelec.fetch_store_sitemap_results import (
    get_and_store_alliedelec_urls,
)
from jobs.competitors.baypower.fetch_store_sitemap_results import (
    get_and_store_baypower_urls,
)
from jobs.competitors.breakerauthority.fetch_store_sitemap_results import (
    get_and_store_breakerauthority_urls,
)
from jobs.competitors.breakerhunter.fetch_store_sitemap_results import (
    get_and_store_breakerhunters_urls,
)
from jobs.competitors.breakeroutlet.fetch_store_sitemap_results import (
    get_and_store_breakeroutlet_urls,
)
from jobs.competitors.chartercont.fetch_store_sitemap_results import (
    get_and_store_chartercontact_urls,
)
from jobs.competitors.circuitbreakerwarehouse.fetch_store_sitemap_results import (
    get_and_store_circuitbreakerwarehouse_urls,
)
from jobs.competitors.controlparts.fetch_store_sitemap_results import (
    get_and_store_controlparts_urls,
)
from jobs.competitors.dkhardware.fetch_store_sitemap_results import (
    get_and_store_dkhardware_urls,
)
from jobs.competitors.gordonelectricsupply.fetch_store_sitemap_results import (
    get_and_store_gordonelectricsupply_urls,
)
from jobs.competitors.globaltestsupply.fetch_store_sitemap_results import (
    get_and_store_globaltestsupply_urls,
)
from jobs.competitors.imc_direct.fetch_store_sitemap_results import (
...
from jobs.competitors.relectric.fetch_store_sitemap_results import (
    get_and_store_relectric_urls,
)
from jobs.competitors.onlinecomponents.fetch_store_sitemap_results import (
    get_and_store_online_components_urls,
)
from jobs.competitors.scheider_electric.fetch_store_sitemap_results import (
    get_and_store_scheiderElectric_urls,
)
from jobs.competitors.digikey.fetch_store_sitemap_results import (
...
from jobs.competitors.sigmasurplus.fetch_store_sitemap_results import (
...
from jobs.competitors.coasttocoastbreaker.fetch_store_livesearch_results import (
    get_and_store_coasttocoastbreaker_urls,
)
from jobs.competitors.mouser.fetch_store_livesearch_results import (
    get_and_store_mouser_urls,
)
from jobs.competitors.shingle.fetch_store_livesearch_results import (
    get_and_store_shingle_urls,
)
from jobs.competitors.newark.fetch_store_livesearch_results import (
    get_and_store_newark_urls,
)
from jobs.competitors.wolfautomation.fetch_store_livesearch_results import (
    get_and_store_wolf_automation_urls,
)
from jobs.competitors.automationdirect.fetch_store_livesearch_results import (
    get_and_store_automation_direct_urls,
)
from jobs.competitors.galco.fetch_store_livesearch_results import (
