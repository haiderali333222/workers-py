from utils.helpers.index import check_manufacturer_match, preprocess_manufacturers, get_page_with_scraperapi_from_url
...
def get_manufacturer_page_links():
    ...
    try:
        ...
        if manufacturer_page := get_page_with_scraperapi_from_url(MANUFACTURERS_URL, COMPETITOR):
