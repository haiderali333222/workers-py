from utils.helpers.index import url_insert_bulk, preprocess_manufacturers, get_sitemap_urls
from utils.slack import error_slack_message

from .helper import COMPETITOR, STARTING_URL, is_valid_url_and_manufacturer, is_manufacturer_match, MAX_COUNT
