URLS_BY_MANUFACTURER = ['galco', 'shingle', 'mouser', 'zoro', 'onlinecomponents', 'walkerindustrial', 'masterelectronics', 'wolfautomation'
                        'digikey', 'us.rs-online', 'automationdirect', 'newark']
